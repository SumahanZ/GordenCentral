...
class RegisterPageInternal extends ConsumerStatefulWidget {
  const RegisterPageInternal({super.key});

  @override
  ConsumerState<RegisterPageInternal> createState() =>
      _RegisterPageInternalState();
}

class _RegisterPageInternalState extends ConsumerState<RegisterPageInternal> {
                    ...
                    onPressed: () {
                      if (_formKey.currentState!.validate()) {
                        final authCustomerPersonalization = AuthPersonalization(
                            ...
                            role: selectedRoleDropdownValue.toLowerCase());
                        ref
                            .read(authNotifierProvider.notifier)
                            .setPersonalization(authCustomerPersonalization);

                        if (selectedRoleDropdownValue == "Pemilik") {
                          Routemaster.of(context).push("/confirmation-pemilik");
                        } else {
                          Routemaster.of(context)
                              .push("/confirmation-karyawan");
                        }
                      }
                    },
