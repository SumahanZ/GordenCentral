...
class InternalAddStokPage extends ConsumerStatefulWidget {
  const InternalAddStokPage({super.key});

  @override
  ConsumerState<InternalAddStokPage> createState() =>
      _InternalAddStokPageState();
}

//wrap in future

class _InternalAddStokPageState extends ConsumerState<InternalAddStokPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final productSelected = ref.watch(productStokSelectionNotifierProvider);
                      ...
                      child: Padding(
                        ...
                        child: Column(children: [
                          ...
                          ProdukStokCombinationCard(
                            ...
                            buttonDestination:
                                '/internal-dashboard/produkstok/add-stok/selection/add-details',
                            routeDestination:
                          ...
                          DateCustomTextField(
                            ...
                            validator: (value) {
                              if (!(value!.isNotEmpty && value.length > 6)) {
                                return "Invalid tanggal pesanan. Tolong masukkan tanggal pesanan yang valid";
                              } else {
                                return null;
                              }
                            },
