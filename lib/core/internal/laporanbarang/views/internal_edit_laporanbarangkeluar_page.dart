...
class InternalEditLaporanBarangKeluarPage extends StatefulWidget {
  const InternalEditLaporanBarangKeluarPage({super.key});

  @override
  State<InternalEditLaporanBarangKeluarPage> createState() =>
      _InternalEditLaporanBarangKeluarPageState();
}

class _InternalEditLaporanBarangKeluarPageState
    extends State<InternalEditLaporanBarangKeluarPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          "Edit Laporan Barang Keluar Page",
          ...
          child: Padding(
            ...
            child: Column(children: [
              const TopSectionAuth(
                  name: "Edit Laporan Barang Keluar",
                  description: "Edit a laporan barang keluar entry",
