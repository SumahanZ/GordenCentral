...
class InternalEditLaporanBarangMasukPage extends StatefulWidget {
  const InternalEditLaporanBarangMasukPage({super.key});

  @override
  State<InternalEditLaporanBarangMasukPage> createState() =>
      _InternalEditLaporanBarangMasukPageState();
}

class _InternalEditLaporanBarangMasukPageState
    extends State<InternalEditLaporanBarangMasukPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          "Edit Laporan Barang Masuk Page",
          ...
          child: Padding(
            ...
            child: Column(children: [
              const TopSectionAuth(
                  name: "Edit Laporan Barang Masuk",
                  description: "Edit the laporan barang masuk entry",
