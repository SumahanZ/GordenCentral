...
class InternalDashboardPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
        ...
        body: ordersCompletedOngoingCount.maybeWhen(
            data: (data) {
              return data.match(
                  (l) => Center(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                          ...
                          child: Card(
                            ...
                            child: Padding(
                              ...
                              child: Row(children: [
                                const CircleAvatar(
                                  radius: 35,
                                  child: Icon(AntIcons.projectOutlined, size: 35),
                                ),
                                const SizedBox(
                                  width: 15,
                                ),
                        ...
                        GestureDetector(
                          onTap: () => Routemaster.of(context)
                              .push('/internal-dashboard/analisa-keuangan'),
                          child: Card(
                            surfaceTintColor: Colors.white,
                            elevation: 5,
                            child: Padding(
                              ...
                              child: Row(children: [
                                const CircleAvatar(
                                  radius: 35,
                                  child: Icon(AntIcons.stockOutlined, size: 35),
                                ),
                                const SizedBox(
                                  width: 15,
                                ),
                        ...
                        GestureDetector(
                          onTap: () => Routemaster.of(context)
                              .push('/internal-dashboard/laporan-barang'),
                          child: Card(
                            surfaceTintColor: Colors.white,
                            elevation: 5,
                            child: Padding(
